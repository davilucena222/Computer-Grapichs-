...
material.vertexShader = `
    ...
    void main() {
        ...
        //Realizando os cálculos para aplicar o Modelo de Iluminação de Phong usando a Interpolação de Gouraud
        
        //Calculando o termo ambiente
        vec3 termo_ambiente = Ip_ambient_color * k_a;
        
        //Calculando o termo difuso
        vec3 termo_difuso = Ip_diffuse_color * k_d * max(vec3(0.0, 0.0, 0.0), dot(N_cam_spc, L_cam_spc));
        ...
        //Calculando a soma total dos termos acima
        vec3 somatorio_total = termo_ambiente + termo_difuso + termo_especular;
        
        //Atribuindo a variável "I" a variável que contém o cálculo da cor final de cada vértice do objeto para realizar a iluminação
        I = vec4(somatorio_total, 1);
